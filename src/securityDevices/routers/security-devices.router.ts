...
import { DocumentExistGuardMiddleware } from '../DocExistDeviceGuardMiddleware';
...
securityDevicesRouter
  ...
  .delete('/:deviceId', refreshTokenGuard,DocumentExistGuardMiddleware, deleteDeviceHandler);
